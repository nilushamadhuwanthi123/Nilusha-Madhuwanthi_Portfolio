...
(function projectFishbone() {
  ...
  const PROJECTS = [
    ...
    { key:'flappyflight', emoji:'🐤', title:'Flappy Flight', tag:'Personal · Frontend', categories:['Frontend'], status:'live',
      desc:'A for-fun side project built in my free time — a Flappy Bird clone in vanilla JavaScript and the Canvas API, no frameworks or dependencies. Fixed-timestep game loop, hand-drawn bird and pipes, keyboard/touch/mouse controls, and a persisted high score.',
    ...
    { key:'brickvector', emoji:'🧱', title:'Brick Vector', tag:'Personal · Frontend', categories:['Frontend'], status:'live',
      desc:'A for-fun side project built in my free time — a Breakout / brick-breaker clone in vanilla JavaScript and the Canvas API. Real angle-reflection paddle physics, five hand-designed brick layouts with escalating difficulty, and a 3-life system.',
    ...
    { key:'game2048', emoji:'🔢', title:'2048', tag:'Personal · Frontend', categories:['Frontend'], status:'live',
      desc:'A for-fun side project built in my free time — the classic 2048 sliding-tile puzzle in vanilla JavaScript, DOM elements and CSS Grid (no canvas this time). Merge-once-per-move logic, CSS-transition tile animation, and full keyboard/touch/accessibility support.',
    ...
    { key:'precisiondrift', emoji:'🏎️', title:'Precision Drift', tag:'Personal · Frontend', categories:['Frontend'], status:'live',
      desc:'A for-fun side project built in my free time — a more advanced endless car-racing/traffic-dodging game in vanilla JavaScript and Canvas. Smooth lane-changing, procedurally spawned traffic, a considered difficulty curve, and coin/shield pickups.',
